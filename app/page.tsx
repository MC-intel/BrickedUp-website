            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link href="#testimonials" className="text-gray-400 hover:text-orange transition-colors duration-300">
                      Reviews
                    </Link>
                  </li>
                </ul>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <a href="tel:555-123-4567" className="flex items-center space-x-3 text-gray-400 hover:text-orange transition-colors duration-300">
                    <Phone className="h-5 w-5 text-orange" />
                    <span>(555) 123-4567</span>
                  </a>
                  <a href="mailto:contact@elitemasonrydemo.com" className="flex items-center space-x-3 text-gray-400 hover:text-orange transition-colors duration-300">
