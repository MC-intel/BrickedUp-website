        ...
        <section id="portfolio" className="py-20 bg-gray-50">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <CarouselPrevious className="absolute left-[-50px] top-1/2 -translate-y-1/2 fill-amber-600" />
              <CarouselNext className="absolute right-[-50px] top-1/2 -translate-y-1/2 fill-amber-600" />
            </Carousel>
          </div>
        </section>
